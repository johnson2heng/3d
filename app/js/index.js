...
//更新素材库页面信息
function details_company(wrap, src, library) {
	$.ajax({
		type: "get",
		url: src,
		async: true,
		...
		success: function(data_strings) {
			...
			var html = `
				...
				<div class="xiangqing container-fluid company-wrap">
					<div class="row">
						<div class="col-xs-7">
...
//查看详情处理接受数据并添加事件
function details_module(wrap, src, library) {
	//给列表添加查看详情事件
	$.ajax({
		type: "get",
		url: src,
